    ...
    <div class="container-grid">
     ...
     require("conexion.php");
      ...
      if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btnAgregar2'])) {
        ...
        $consulta = "INSERT INTO infoblogs (titulo, fecha, imagen, descripcion, descri2, ima2) VALUES ('$titulo','$fecha','$imagen','$descripcion','$descri2','$ima2')";
      ...
      <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" onsubmit="return validateForm();">
        <div class="formulario-columna">
          ...
          <input type="text" id="fecha" name="fecha" required
            placeholder="Ingrese la fecha del blog con este formato: aaaa/mm/dd">
